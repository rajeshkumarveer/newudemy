    ...
    return (
        <div >
            ...
            <div className="row footer1">
                <div className="col-md-3 col-6"><b>Udemy for Business <br /> Teach on Udemy</b><br />Udemy app <br />About us</div>
                <div className="col-md-3 col-6">Careers<br />Blog <br />Help and Support <br /> Affiliate</div>
                <div className="col-md-3 col-6">SiteMap <br />Featured courses</div>
                <div className="col-md-3 col-6 fs" style={{ textAlign: "end" }}><button className="btn btn-outline-login my-2 my-sm-0" style={{ padding: "1vh 4vh" }}><i className="fa fa-globe" aria-hidden="true"></i> <b>English</b></button></div>
            </div>
            <hr></hr>
            <div className="row footer2">
                ...
                <div className="col-md-5 tinitiny1"style={{ textAlign: "end" }}>Terms Privacy Policy and Cookie Policy</div>
            </div>
